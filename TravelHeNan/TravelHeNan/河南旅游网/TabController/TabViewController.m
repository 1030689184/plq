...
@interface TabViewController ()<CustomTabbarDeleagte>
...
//    UIImageView *imageView1 = [[UIImageView alloc]initWithFrame:CGRectMake(0, -8, self.tabBar.frame.size.width, self.tabBar.frame.size.height+8)];
//    imageView1.image = [UIImage imageNamed:@"背景_gray"];
//    [self.tabBar addSubview:imageView1];
    ...
    imageView.image = [UIImage imageNamed:@"背景_gray"];
...
-(void)setUpChildcontroller{
    ...
    //主页
    CYMainViewController *main = [[CYMainViewController alloc]init];
    [self addChildViewController:main andTitle:@"首页" andImage:[UIImage imageNamed:@"home_gray"] andSelectedImage:[UIImage imageNamed:@"home_01"]];
    
    //分类
    CYKindViewController *kind = [[CYKindViewController alloc]init];
    [self addChildViewController:kind andTitle:@"分类" andImage:[UIImage imageNamed:@"product_gray"] andSelectedImage:[UIImage imageNamed:@"product_01"]];

    
    //商城
    CYShopViewController *shop = [[CYShopViewController alloc]init];
    [self addChildViewController:shop andTitle:@"商城" andImage:[UIImage imageNamed:@"shop_gray"] andSelectedImage:[UIImage imageNamed:@"shop_01"]];
    
    //会员
    CYPartnerVC *partner = [[CYPartnerVC alloc]init];
    [self addChildViewController:partner andTitle:@"会员" andImage:[UIImage imageNamed:@"member_gray"] andSelectedImage:[UIImage imageNamed:@"member_01"]];
