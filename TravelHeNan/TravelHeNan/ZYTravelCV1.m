...
#import "ZYTravelCV1.h"
#import "CYSearchViewController.h"
#import "CYUpdate.h"

@interface ZYTravelCV1 ()<UITableViewDataSource,UITableViewDelegate>
@property (nonatomic, retain) UITableView *bigTableView;

@end

@implementation ZYTravelCV1
...
-(void)setRequestHttp
{
    ...
    [CYHttpRequest requestGetA1Completion:^(NSArray *dataArray) {
        [_dataArray addObject:dataArray];
        [CYHttpRequest requestGetA2Completion:^(NSArray *dataArray) {
            [_dataArray addObject:dataArray];
            [CYHttpRequest requestGetA3Completion:^(NSArray *dataArray) {
                [_dataArray addObject:dataArray];
                [CYHttpRequest requestGetA4Completion:^(NSArray *dataArray) {
                    [_dataArray addObject:dataArray];
                    [CYHttpRequest requestGetA5Completion:^(NSArray *dataArray) {
                        [_dataArray addObject:dataArray];
                        [CYHttpRequest requestGetA6Completion:^(NSArray *dataArray) {
                            [CYHttpRequest requestGetA7Completion:^(NSArray *dataArray) {
                                [CYHttpRequest requestGetA8Completion:^(NSArray *dataArray) {
                                    [_dataArray addObject:dataArray];
