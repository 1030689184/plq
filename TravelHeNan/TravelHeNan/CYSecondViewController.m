...
@interface CYSecondViewController ()<UITableViewDataSource,UITableViewDelegate>
...
- (void)viewDidLoad {
    ...
    [CYHttpRequest requestToGetTwoCompletion:^(NSArray *dataArray) {
...
{
    ZYTravelCV1 *vc = [[ZYTravelCV1 alloc]init];
