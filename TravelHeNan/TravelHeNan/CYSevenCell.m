...
#import "CYSevenCell.h"
#import "CYShowViewController.h"

@implementation CYSevenCell
...
-(void)showData:(NSArray *)dataArray
{
    ...
    for (int i =0 ; i < dataArray.count; i ++ )
    {
        ...
        button.frame = CGRectMake((CELL_WIDTH-6)*i, 0, CELL_WIDTH, CELL_HEIGHT*4/5);
        button.tag = 1001+i;
...
-(void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    if (_scrollView.contentOffset.x==(CELL_WIDTH-6)*3) {
