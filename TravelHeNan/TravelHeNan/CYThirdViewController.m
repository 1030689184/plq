...
@interface CYThirdViewController ()<UITableViewDataSource,UITableViewDelegate>
...
- (void)viewDidLoad {
    ...
    [CYHttpRequest requestToGetThirdCompletion:^(NSArray *dataArray) {
...
{
    ZYTravelCV2 *vc = [[ZYTravelCV2 alloc]init];
