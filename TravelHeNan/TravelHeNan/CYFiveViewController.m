...
@interface CYFiveViewController ()<UITableViewDataSource,UITableViewDelegate>
@property (nonatomic, retain) UITableView *bigTableView;

@end

@implementation CYFiveViewController
...
-(void)setRequestHttp
{
    [CYHttpRequest requestGetA9Completion:^(NSArray *dataArray) {
