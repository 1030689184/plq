...
@interface CYSixViewController ()<UITableViewDataSource,UITableViewDelegate>
@property (nonatomic, retain) UITableView *bigTableView;

@end

@implementation CYSixViewController
...
-(void)setRequestHttp
{
    [CYHttpRequest requestGetA10Completion:^(NSArray *dataArray) {
